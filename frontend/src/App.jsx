...
export default function App() {
  return <Router><AuthProvider><div className="min-h-screen bg-slate-50 text-slate-900"><Sidebar/><div className="min-h-screen lg:pl-[268px]">
    <Routes>
      ...
      <Route path="/assessment" element={<Routed title="New Assessment" roles={["user"]}><Assessment/></Routed>}/>
      <Route path="/result" element={<Routed title="Assessment Result" roles={["user"]}><Result/></Routed>}/>
